        ...
        <div className="partner">
            <div className="partner-hero">
                <div className="hero-txt size ">
                    <h1 className="page-title reveal">Стать партнером</h1>
            ...
            <div className="divider size reveal">
                ...
                <div className="divider-line">
                    ...
                    <p className="page-text">
                        ...
                        а также маркетинговую поддержку с рекламными материалами. Мы проводим обучение и консультации
                        для
                        повышения ваших знаний о продукции. Конкурентные цены и гибкие условия помогут эффективно
                        развивать
